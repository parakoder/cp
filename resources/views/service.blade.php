            ...
            <div class="col-lg-4">
                ...
                <div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
                    ...
                    <div class="link-animated d-flex flex-column justify-content-start">
                        ...
                        <a class="h5 fw-semi-bold bg-light rounded py-2 px-3 mb-2" href="{{url('/service?service-id=mobile-development')}}"><i class="bi bi-arrow-right me-2"></i>Mobile Development</a>
                    </div>
                </div>
                <!-- Category End -->
            </div>
